...
class Application(Frame):
    ...
    def createWidgets(self):
        ...
        self.st2 = Label(self, text='工件宽度 Y ')
        ...
        self.st6 = Label(self, text='每次下切深度 ')
        ...
        self.st5 = Label(self, text='总共下切深度 ')
        ...
        self.st7 = Label(self, text='每步路径覆盖百分比 ')
        ...
        self.st9=Label(self,text='X0-Y0原点位置')
        self.st9.grid(row=3,column=5)
        HomeOptions=[('工件左后',4),('工件左前',5)]
        self.HomeVar=IntVar()
        ...
        self.CopyButton.grid(row=8, column=3)
        ...
        for i in range(self.NumOfYSteps):
            ...
            if self.HomeVar.get()==4:
                if self.Y_Position < self.Y_End:
                    #self.g_code.insert(END, 'Y_End= %.4f\n' % (self.Y_End))
